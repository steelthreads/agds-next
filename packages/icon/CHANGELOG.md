...
- 8969f876a: Add WarningIcon and InfoIcon

### Patch Changes

- 43fa70f0f: Updated documentation
...
- ae1ca403: Add UploadIcon
- ae1ca403: Add large Icon size
- f596c8b5: Add CopyIcon
...
- 35f6f094: Move icon width/height to css
- 1d641451: Removed logic for responsive `color` prop
